...
D3bot.BotAttackAngLerpFactor = 0.195 --0.5		-- See above, but for attacking //the higher the number, the more accurate the bots will be with their attacks/tracking on players.
